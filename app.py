...
- اكتب ردك في فقرة نصية واحدة متصلة (مثل المقالات والكتب).
- استخدم علامات الترقيم (النقاط، الفواصل، علامات الاستفهام والتعجب) لفصل الجمل داخل الفقرة.
- لا تستخدم أي رموز تنسيق مثل ** أو * أو _ أو # أو ``` أو أي شيء مشابه.
- اترك سطراً فارغاً بين الفقرات المختلفة، وفقط بينها.
- اجعل أسلوبك واضحاً ومفيداً، وتجنب الإطالة غير الضرورية.
- حافظ على لهجتك العامية البيضاء، وكن لطيفاً ومحترماً.
"""
def remove_emoji(t):
