...
- يجب أن يكون ردك كاملاً بتنسيق Markdown.
- استخدم العناوين (`#`, `##`, `###`) لتقسيم الموضوع.
- استخدم القوائم المرقمة والنقطية (`-` أو `1.`) لعرض النقاط.
- استخدم **الخط العريض** و *المائل* و `الكود المضمن` وكتل الأكواد (```) عند الحاجة.
- اكتب فقرات نصية متصلة، لكن افصل بين الفقرات بسطر فارغ.
- استخدم الجداول إذا كان ذلك مفيداً.
