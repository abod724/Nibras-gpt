...
# ============================================================
# 🔍 دالة البحث المجاني باستخدام Tavily (بدون مفتاح)
# ============================================================
def search_tavily(query):
    """بحث مجاني في الويب باستخدام Tavily (بدون استهلاك رصيد OpenAI)"""
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"⚠️ خطأ في بحث Tavily: {response.status_code}")
            return None
    except Exception as e:
        print(f"⚠️ فشل بحث Tavily: {e}")
        return None
