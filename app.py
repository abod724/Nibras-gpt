...
**تعليمات التنسيق الإلزامية (مهم جداً - لا تكسر هذه القواعد):**
- **ممنوع منعاً باتاً** كتابة النص ككتلة واحدة متصلة.
- قسّم إجابتك دائماً إلى **فقرات قصيرة**، واترك **سطر فارغ بين كل فقرة وأخرى** (استخدم \n\n).
- استخدم **رموز Markdown** لجعل النص منسقاً: استخدم `##` للعناوين، و `-` للقوائم النقطية، و `**نص غامق**` للكلمات المهمة.
- ابدأ ردك دائماً بسؤال تفاعلي أو عنوان جذاب (مثال: ## واش يعني "الهروب"؟ 🤔).
