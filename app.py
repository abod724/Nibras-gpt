...
// ========== دالة تنسيق النص (تم إلغاء Markdown، يعرض النص كما هو) ==========
function formatBotText(t){ 
    // إزالة أي محاولات تنسيق، فقط نعرض النص العادي مع استبدال الأسطر بفواصل HTML
    let s=String(t||'');
    // استبدال الأسطر المتتالية بفقرات
