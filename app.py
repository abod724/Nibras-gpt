...
/* ====== تنسيق صندوق الكود مع زر نسخ مخصص ====== */
.code-block-wrapper{position:relative;margin:12px 0;border-radius:12px;border:1px solid var(--border-color);background:var(--bg-input);overflow:hidden;display:inline-block;max-width:100%;overflow-x:auto}.code-block-wrapper pre{margin:0;padding:12px 40px 12px 14px;background:transparent;border:none;border-radius:0;white-space:pre-wrap;word-break:break-word}.code-block-wrapper .copy-code-btn{position:absolute;top:8px;left:8px;background:var(--bg-hover);border:1px solid var(--border-color);color:var(--text-secondary);border-radius:8px;padding:4px 10px;font-size:12px;cursor:pointer;transition:all .2s;z-index:5}.code-block-wrapper .copy-code-btn:hover{background:var(--primary-color);color:#fff;border-color:var(--primary-color)}.code-block-wrapper .copy-code-btn.copied{background:#28a745;color:#fff;border-color:#28a745}
...
// ========== دالة نسخ الكود من الأزرار المخصصة ==========
