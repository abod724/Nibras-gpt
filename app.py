...
# ✅ CORS لصفحة حذف الحساب على GitHub Pages
@app.after_request
...
# ✅ استقبال طلبات حذف الحساب من صفحة الويب (مع التحقق من كلمة المرور)
